        ...
        <>
            ...
            <div>
                ...
                <div className="mt-10 mb-10">
                    ...
                    <ul className="px-[32px] leading-8 list-disc list-outside text-[12px] md:text-[16px]">
                        <li> [이슈] 협약사는 '소유(부동산 STO 회사)'를 레퍼런스로 요청. 해당 어플에는 '하단 메뉴바' 가 없었음. </li>
                        <li> [해결과정]</li>
                            <li className='ml-10 list-none '> 1. '메뉴 하단 바'가 없는 경우, 정보접근성이 떨어진다고 판단</li>
                            <li className='ml-20 text-sm text-gray-500 list-none'> EX) 거래 페이지를 보다가, '물건 팔 때, 내가 청약한 물건을 얼마였지?' 를 참고 하고 싶다는 생각이 들면 '현재 페이지 - 홈 - 마이페이지' 로 '페이지 이동' 을 하게 됨 </li>
                            <li className='ml-10 list-none '> 2. 고객 관점에서 '투자' 는 복합적 판단이 필요하기에 다양한 정보에 빠른 접근이 필요 </li>
                            <li className='ml-10 list-none '> 3. ''메뉴 하단 바' 추가를 통해, 정보 접근의 효율성 제고 </li>
                            <li className='ml-20 text-sm text-gray-500 list-none'> EX) 거래 페이지를 보다가, '물건 팔 때, 내가 청약한 물건을 얼마였지?' 를 참고 하고 싶다는 생각이 들면 '페이지 전환 없이' 마이페이지로 접근 가능 </li>
